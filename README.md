...
# Video Portfolio - Easy Editing Guide

This site is designed to make adding videos extremely simple. Just follow these instructions:

## How to Add Videos

1. Open the `index.md` file
2. Add videos under the appropriate heading (or add a new heading)
3. Simply paste the iframe embed code you get from YouTube or other platforms
